...
export const InfrastructureContent: React.FC<InfrastructureContentProps> = ({ cmsData }) => {
  ...
  // Row 1 item (Cutting & Processing)
  const row1Item = industries[0]
  // Row 2 items (Toughening Plant, Lamination & Cleanroom)
  const row2Items = industries.slice(1, 3)
  // Row 3 items (Double Glazing DGU, Quality Control Center)
  ...
  return (
    <div style={{ paddingTop: '70px', backgroundColor: 'var(--color-black)', color: 'var(--color-taupe)' }}>
        ...
        {/* 2. INFRASTRUCTURE & FACILITIES Section (Desktop View - Parallax 2x2 Grid matching /industry-solution) */}
        <section ref={sectionRef} className={styles.desktopProductSection}>
          <div className={styles.container}>
                  ...
                  <div className={styles.imageWrapper}>
                    ...
                    <div className={styles.hoverDetailsOverlay}>
                      <div className={styles.hoverContent}>
                        ...
                        <span className={styles.hoverLink}>EXPLORE FACILITY →</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div ref={row1TextRef} className={styles.row1TextContent}>
                ...
                <div className={styles.ctaWrapper}>
                  <button type="button" className="btn-black" onClick={openQuoteDrawer}>
                    ↳ {page.ctaText.toUpperCase()}
                  </button>
                </div>
              </div>
            </div>

            {/* ROW 2: 2 Cards (Toughening Plant & Lamination Cleanroom) */}
            ...
            {/* ROW 3: 2 Cards (Double Glazing DGU & Quality Control Center) */}
        ...
        {/* 3. Mobile Pinned Diagonal Scale Scene (Mobile View matching /industry-solution) */}
